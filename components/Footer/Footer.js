  ...
  return (
    <div className={styles.footer_container}>
      <Image
        ...
        alt="hero image"
        placeholder="blur"
        blurDataURL="/images/footer.webp"
        loading="lazy"
      />
      ...
      <div className={styles.footer_links_container}>
        <Grid container>
          <Grid item xs={6} md={3}>
            ...
            <div className={styles.link_section}>
              <Link href="/roseville-ca/kitchen-remodeling-roseville-ca">
                <Typography variant="body1">
                  Roseville Kitchen Remodel
                </Typography>
              </Link>
              <Link href="/roseville-ca/bathroom-remodeling-roseville-ca">
                <Typography variant="body1">
                  Roseville Bathroom Remodel
                </Typography>
              </Link>
              <Link href="/roseville-ca/replacement-windows-roseville-ca">
                <Typography variant="body1">Roseville Windows</Typography>
              </Link>
              <Link href="/folsom-ca/kitchen-remodeling-folsom-ca">
                <Typography variant="body1">Folsom Kitchen Remodel</Typography>
              </Link>
          ...
          <Grid item xs={6} md={3}>
            ...
            <div className={styles.link_section}>
              ...
              <a href="tel:+19168867113" rel="noreferrer">
                <Typography component="small">
                  <b>+1(916)886-7113</b>
                </Typography>
              </a>
        ...
        <div className={styles.brnads_logo_container}>
          ...
          <div className={styles.sub_brands_image}>
            ...
            <div className={styles.brands_title2}>
              <a href="https://nkba.org/" target="_blank" rel="noreferrer">
                <Image
                  src="//images/NKBA.svg"
                  width={300}
                  height={100}
        ...
        <div className={styles.footer_line}>
          <Typography component="small">
            ...
            <a href="https://www.arcrel.com/" target="_blank" rel="noreferrer">
              <Image
