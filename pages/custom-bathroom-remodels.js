...
const CustomBathroomRemodeling = () => {
  ...
  return (
    <div className={styles.single_service_container}>
      <NextSeo
        title="Custom Bathroom Contractor - Bathroom Remodel Sacramento"
        description="If your bathroom is outdated or needs a fresh new look, call JC Construction for bathroom remodeling in Sacramento."
        ...
        <div className={styles.hero_header_container}>
          ...
          <div className={styles.header_content}>
            <Typography variant="h1">
              Custom Bathroom Remodels Sacramento
            </Typography>
