...
const CustomKitchenRemodeling = () => {
  ...
  return (
    <div className={styles.single_service_container}>
      <NextSeo
        title="Kitchen Remodeling Sacramento - Custom Kitchen Remodels"
        description="Kitchen remodeling Sacramento upgrade your kitchen today! Call JC Construction and Remodeling for a custom kitchen remodel."
        ...
        <div className={styles.hero_header_container}>
          ...
          <div className={styles.header_content}>
            <Typography variant="h1">
              Custom Kitchen Remodeling Sacramento
            </Typography>
