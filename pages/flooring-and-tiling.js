...
const FlooringAndTiling = () => {
  ...
  return (
    <div className={styles.single_service_container}>
      <NextSeo
        title="Flooring and Tiling Contractor Sacramento, CA"
        description="Upgrade To flawless floors - Schedule a flooring installation appointment in Sacramento. We replace floors all over Sacramento, CA, and surrounding areas."
      ...
      <Container maxWidth="xl" disableGutters={true}>
        <div className={styles.hero_header_container}>
          ...
          <div className={styles.header_content}>
            <Typography variant="h1">Flooring and Tiling Sacramento</Typography>
