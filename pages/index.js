...
const Map = dynamic(() => import("../components/MapComponent/MapComponent"));
...
const Home = ({ blogs }) => {
  return (
    <div className={styles.home_container}>
      <NextSeo
        title="Kitchen & Bathroom Remodeling Contractors Sacramento CA"
        description="Kitchen and Bathroom Remodeling Contractors in Northern California | JC Construction and Remodeling | Home Renovation Company Sacramento CA."
      ...
      <Container maxWidth="xl" disableGutters={true}>
        <div className={styles.hero_header_container}>
          <Image
            ...
            alt="hero image"
            placeholder="blur"
            blurDataURL="/images/home_hero.webp"
          />
          <div className={styles.overlay}></div>
          <div className={styles.header_content}>
            <Typography variant="h1">
              Kitchen and Bathroom Remodeling Contractors in Sacramento, CA
            </Typography>
        ...
        <div className={styles.our_clients_container}>
          ...
          <Typography variant="body1">
            ...
            to tell us about any remodel design ideas you have.
          </Typography>
          <OurClients />
        </div>
        ...
        <div className={styles.view_products_container}>
          <Image
            src="/images/prod_bg.webp"
            layout="fill"
            objectFit="cover"
            alt="hero image"
            placeholder="blur"
            blurDataURL="/images/prod_bg.webp"
            loading="lazy"
          />
