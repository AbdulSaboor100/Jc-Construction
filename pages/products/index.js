...
import { SecondaryButtonWhite } from "../../components/Buttons/Buttons";
        ...
        <div className={styles.hero_header_container}>
          ...
          <div className={styles.header_content}>
            ...
            <div className={styles.heroButton}>
              <a href="https://prideindustrial.com/" target="_blank">
                <SecondaryButtonWhite> Shop Handles</SecondaryButtonWhite>
              </a>
            </div>
          </div>
        </div>
