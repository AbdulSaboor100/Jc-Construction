...
const WindowsAndDoors = () => {
  ...
  return (
    <div className={styles.single_service_container}>
      <NextSeo
        title="Replacement Windows and Doors Sacramento, CA"
        description="Replacement Windows and Doors in Sacramento, CA and surrounding areas | 916-886-7113 Is it time to replace your windows and doors?"
      ...
      <Container maxWidth="xl" disableGutters={true}>
        <div className={styles.hero_header_container}>
          <Image
            src="//images/services/windows-and-doors/windows-and-doors.webp"
            layout="fill"
            objectFit="cover"
            alt="Windows and Doors"
            placeholder="blur"
            blurDataURL="/images/services/windows-and-doors/windows-and-doors.webp"
          />
