...
const Siding = () => {
  ...
  return (
    <div className={styles.single_service_container}>
      <NextSeo
        title="Siding Contractor Sacramento, CA"
        description="Full-Service siding experts in Sacramento & surrounding areas. Residential siding contractor Sacramento."
      ...
      <Container maxWidth="xl" disableGutters={true}>
        <div className={styles.hero_header_container}>
          <Image
            src="//images/services/siding/siding.webp"
            layout="fill"
            objectFit="cover"
            alt="Siding"
            placeholder="blur"
            blurDataURL="/images/services/siding/siding.webp"
          />
          <div className={styles.overlay}></div>
          <div className={styles.header_content}>
            <Typography variant="h1">Siding Installation Sacramento</Typography>
